function [ weights, generalization_errors ] = minover(data, labels, n_max, w_star)
    ...
    while not_converged(weight_storage, P, N) && t < t_max
        t = t + 1;
...
function [ret] = not_converged(weight_storage, P, N)
   ret = sum(sum(weight_storage == repmat(weight_storage(1, :), P, 1))) ~= P * N;
end
